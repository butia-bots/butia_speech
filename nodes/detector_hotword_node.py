...
if __name__ == '__main__':
    ...
    keyword = [PACK_DIR + '/resources/Hello-Doris_en_linux_v2_1_0.ppn', PACK_DIR + '/resources/Follow-me_en_linux_v2_1_0.ppn', PACK_DIR + '/resources/OK-DORIS_en_linux_v2_2_0.ppn']
