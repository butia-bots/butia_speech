...
def handle_recognition(req):
    ...
    try:
        ...
        with AudioToTextRecorder(language='en',
            enable_realtime_transcription=False,
            initial_prompt= req.prompt if req.prompt != '' else None,
            ...
            silero_deactivity_detection=True,) as recorder:
            # Get the recognized text
            thread1 = threading.Thread(target=delay_start_recorder)
            thread1.start()
